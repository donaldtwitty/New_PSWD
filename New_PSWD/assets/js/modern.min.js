document.addEventListener('DOMContentLoaded', function () {
    ...
    const n = document.querySelector('.menu-trigger');
    (n &&
        n.addEventListener('click', function () {
            this.classList.toggle('active');
            const e = document.querySelector('.header-area .nav');
    ...
    const o = document.getElementById('contact-form'),
        c = document.getElementById('thankyou-popup');
    (o &&
        o.addEventListener('submit', async function (e) {
            e.preventDefault();
            const t = new FormData(o);
            try {
                const e = await fetch('https://formspree.io/f/xzzrnyzr', {
                    method: 'POST',
                    body: t,
                    headers: { Accept: 'application/json' },
                });
                e.ok
                    ? (c.classList.remove('js-hidden'), o.reset())
                    : alert(
        ...
        (window.closePopup = function () {
            c.classList.add('js-hidden');
        }),
        (function () {
            const b = document.querySelector('.popup-button');
            b && b.addEventListener('click', window.closePopup);
        })());
    const r = document.getElementById('back-to-top');
    r &&
    ...
    const l = document.getElementById('dark-mode-toggle'),
